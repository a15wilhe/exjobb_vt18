...
$query = "SELECT logID, href, scrollY, scrolls, TIMESTAMP FROM scroll_table";
...
<td align="left"><b>scrollY</b></td>
<td align="left"><b>scrolls</b></td>
...
$row['scrollY'] . '</td><td align="left">' . 
$row['scrolls'] . '</td><td align="left">' .
...
{
    mysqli_query($dbc, 'TRUNCATE TABLE `scroll_table`');
    exit();
}
